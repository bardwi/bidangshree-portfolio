...
const en = {
  ...
  hero: {
    ...
    titleEm: 'buildable ',
    titlePost: 'products.',
    lede: 'Product Owner / Product Manager in Berlin with a frontend background and a strong focus on UX/UI. I care about turning user research and unclear requirements into clear product decisions - and shaping ideas that are easy for users to understand and realistic for teams to build. PSPO™ I certified.',
    ...
    training: [
      {
        ...
        certificateHref: '/certificate/dl-certificate.pdf',
      },
      {
        when: '2026',
...
const de: Dict = {
  ...
  hero: {
    ...
    titleEm: 'umsetzbare ',
    titlePost: 'Produkte.',
    lede: 'Product Owner / Product Manager in Berlin mit Frontend-Hintergrund und starkem Fokus auf UX/UI. Mir ist wichtig, Research-Erkenntnisse und unklare Anforderungen in klare Produktentscheidungen zu übersetzen - damit Ideen für Nutzer:innen verständlich und für Teams realistisch umsetzbar bleiben. PSPO™ I zertifiziert.',
